...
$$+\frac{k}{2}\log{2\pi}+\frac{1}{2}\log{|\Sigma_2|} + \frac{1}{2}(x-\mu_2)^T\Sigma_2^{-1}(x-\mu_2))$$
...
$$D_{KL}(q(\mathbf{z}|\mathbf{x})||p(\mathbf{z}|\mathbf{x}))=\sum_{z}q(\mathbf{z}|\mathbf{x})\log\frac{q(\mathbf{z}|\mathbf{x})}{p(\mathbf{z}|\mathbf{x})}$$ $$=E_{z\sim{q(\mathbf{z}|\mathbf{x})}}[\log(q(\mathbf{z}|\mathbf{x})) - p(\mathbf{z}|\mathbf{x})]$$ 
